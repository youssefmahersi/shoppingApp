...
export const errorMessage = () => {
    return(
        <div className="error-message">
            <span className="error-text">You must first run the server to download the server, please go to the following link:</span>
            <a href='https://github.com/Qandeeil/Shopping' target='_blank'>https://github.com/Qandeeil/Shopping</a>
        </div>
    )
}